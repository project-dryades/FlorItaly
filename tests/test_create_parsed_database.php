...
// mi connetto al database flore_checklist_2018
...
$query_nomi_accettati = 'SELECT entita FROM checklist';
...
$query_nomi_accettati2 = 'SELECT entita FROM sinonimi';
...
$query_nomi_sinonimi = 'SELECT entita, sinonimo FROM sinonimi';
...
foreach ($accepted_names as $accepted_name) {
    ...
    $accepted = $namematch->parseChecklistName($accepted_name, 'entita', 'sinonimo', $accepted_name['id_synonym_table']);
    /*test
    if ($i == 15962){
        print_r($accepted);
