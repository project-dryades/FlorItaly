...
//			$this->xml = new SimpleXml(XML_STRING);
		...
		* @return string
		*/
		public function treat_word( $str2, $strip_ending = 0, $normalize=0 ) {
      ...
      if ( ( $str2 == NULL ) || ( trim($str2) == '' ) ) {
        ...
        elseif(preg_match('/^J/', $temp2))   $temp2 = preg_replace('/^J/', 'I', $temp2);
        elseif(preg_match('/^H/', $temp2))   $temp2 = preg_replace('/^H/', '', $temp2);
